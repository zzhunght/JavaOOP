...
public class error extends javax.swing.JDialog {
     ...
     */
    public error( boolean modal,String name) {
    ...
    private void initComponents() {
        ...
        mainbutton1.setBackground(new java.awt.Color(255, 51, 51));
        mainbutton1.setBorder(null);
        mainbutton1.setForeground(new java.awt.Color(255, 255, 255));
        mainbutton1.setText("Thoát");
        mainbutton1.setAutoscrolls(true);
        mainbutton1.setBorderColor(new java.awt.Color(255, 51, 51));
        mainbutton1.setColor(new java.awt.Color(255, 51, 51));
        mainbutton1.setColorClick(new java.awt.Color(255, 102, 102));
        mainbutton1.setColorOver(new java.awt.Color(255, 102, 102));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\JAVA\\ProjectOOP\\ProjectOOP\\src\\main\\resources\\iconnoti\\box-important2.png")); // NOI18N
